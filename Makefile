...
trex_tests: trex_tests.o trex.o
	$(CXX) $(CXXFLAGS) trex_tests.o trex_exec.o trex_verify.o -o trex_tests && ./trex_tests
...
trex_tests.o: trex_tests.cpp trex.h trex_opcodes.h trex_exec.o trex_verify.o
